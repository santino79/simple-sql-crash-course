...
date: 1901-01-01
description: "An introduction to SQL, how to pronounce SQL, where it was developed and what you can use it for."
slug: sql-what-is-sql
categories: ['lessons']
keywords: ['sql','what']
...
[Try the next lesson](/sql-select)